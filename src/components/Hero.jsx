    ...
    <section id='home' className='hero'>
      ...
      <div className='hero-content'>
        ...
        <p className='hero-description'>
          React and Next.js engineer focused on clean interfaces, strong
          performance, technical SEO, and practical AI-assisted workflows.
        </p>
      ...
      <div className='hero-terminal-wrapper'>
          ...
          <div className='terminal-body'>
            ...
            <div className='code-content'>
              ...
              <div className='code-indent'>
                ...
                <span className='code-symbol'>:</span>{' '}
                <span className='code-array'>["React", "Next.js", "TypeScript"]</span>
                <span className='code-symbol'>,</span>
              </div>
              <div className='code-indent'>
                <span className='code-key'>"aiTooling"</span>
                <span className='code-symbol'>:</span>{' '}
                <span className='code-array'>["Cursor", "Claude", "ChatGPT", "Copilot", "Gemini"]</span>
                <span className='code-symbol'>,</span>
              </div>
              <div className='code-indent'>
                <span className='code-key'>"focus"</span>
                <span className='code-symbol'>:</span>{' '}
                <span className='code-array'>["Performance", "SEO", "Accessibility"]</span>
                <span className='code-symbol'>,</span>
              </div>
              <div className='code-indent'>
        ...
        <div className='floating-code-card'>
          ...
          <div className='floating-code-body'>
            ...
            <br />
            <span className='code-white'>&nbsp;&nbsp;"Build", "Debug", "Review"</span>
            <br />
            <span className='code-yellow'>]</span>
          </div>
        </div>
